...
?>
    <div class="row" >
      ...
      <div class="col-xs-6 col-sm-3"><input id="url" type="text" size="36" value="<?php echo $options['url']; ?>" name="logo_options_group[url]" /> <input id="upload_logo_button" type="button" value="Upload logo" /> <br />Enter an URL or upload an image from the media</div>
    </div>
...
function display_eya_fields()
{
    ...
    <div class="row">
      <div class="col-xs-6 col-sm-2"><strong>Date:</strong></div>
      <div class="col-xs-6 col-sm-3"><input type="text" name="eya_event_date" id="eya_event_date" value="<?php echo get_option('eya_event_date'); ?>"/></div>
    </div>

    <div class="row">
        <div class="col-xs-6 col-sm-2"><strong>Title:</strong></div>
        <div class="col-xs-6 col-sm-3"><input type="text" name="eya_title" id="eya_title" value="<?php echo get_option('eya_title'); ?>"/></div>
    </div>

    <div class="row">
        <div class="col-xs-6 col-sm-2"><strong>Description:</strong></div>
        <div class="col-xs-6 col-sm-3"><textarea type="text" name="eya_desc" id="eya_desc"><?php echo get_option('eya_desc'); ?></textarea></div>
    </div>

    <div class="row">
      <div class="col-xs-6 col-sm-2"><strong>Headline section one:</strong></div>
      <div class="col-xs-6 col-sm-3"><input type="text" name="eya_headline_section_one" id="eya_headline_section_one" value="<?php echo get_option('eya_headline_section_one'); ?>"/></div>
    </div>

    <div class="row">
      <div class="col-xs-6 col-sm-2"><strong>Headline section two:</strong></div>
      <div class="col-xs-6 col-sm-3"><input type="text" name="eya_headline_section_two" id="eya_headline_section_two" value="<?php echo get_option('eya_headline_section_two'); ?>"/></div>
    </div>

    <div class="row">
      <div class="col-xs-6 col-sm-2"><strong>Headline section three:</strong></div>
      <div class="col-xs-6 col-sm-3"><input type="text" name="eya_headline_section_three" id="eya_headline_section_three" value="<?php echo get_option('eya_headline_section_three'); ?>"/></div>
    </div>

    <div class="row">
      <div class="col-xs-6 col-sm-2"><strong>Headline section four:</strong></div>
      <div class="col-xs-6 col-sm-3"><input type="text" name="eya_headline_section_four" id="eya_headline_section_four" value="<?php echo get_option('eya_headline_section_four'); ?>"/></div>
    </div>

    <div class="row">
      <div class="col-xs-6 col-sm-2"><strong>Twitter:</strong></div>
      <div class="col-xs-6 col-sm-3"><input type="text" name="twitter_url" id="twitter_url" value="<?php echo get_option('twitter_url'); ?>"/></div>
    </div>

    <div class="row">
      <div class="col-xs-6 col-sm-2"><strong>Facebook:</strong></div>
      <div class="col-xs-6 col-sm-3"><input type="text" name="facebook_url" id="facebook_url" value="<?php echo get_option('facebook_url'); ?>"/></div>
    </div>

    <div class="row">
      <div class="col-xs-6 col-sm-2"><strong>Pinterest:</strong></div>
      <div class="col-xs-6 col-sm-3"><input type="textar" name="pinterest_url" id="pinterest_url" value="<?php echo get_option('pinterest_url'); ?>"/></div>
    </div>
    ...
    <div class="row">
      ...
      <div class="col-xs-6 col-sm-3"><textarea name="footer_copyright" id="footer_copyright"><?php echo get_option('footer_copyright'); ?></textarea></div>
    </div>
